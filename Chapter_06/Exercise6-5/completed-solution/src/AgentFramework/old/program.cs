...
// This version of program.cs does not have a conversation thread to accept user input.
// There is just a hard-coded prompt to demonstrate the multi-agent workflow.
       ...
       //Define the GetWeather function with appropriate descriptions
        ...
        static async Task Main(string[] args)
        {
            ...
            ChatClientAgent WeatherAgent = new(client,
                "You are a weather information agent for US cities.",
                "WeatherAgent",
            ...
            ChatClientAgent ReviewerAgent = new(client,
                "You are a reviewer of *WEATHER APPROPRIATE* planned events. Evaluate the feasibility, appeal, and logistics of the proposed activities. " +
            ...
            var messages = new List<ChatMessage> {
                new(ChatRole.User, "Plan event for Seattle today.")
            };
